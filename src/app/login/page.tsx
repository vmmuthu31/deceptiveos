...
import { RiAlertLine, RiArrowRightLine, RiLockPasswordLine, RiMailLine, RiShieldCrossLine } from 'react-icons/ri';
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center items-center p-4 font-sans">
      <div className="w-full max-w-md space-y-6">
        ...
        <p className="text-[11px] text-slate-400 text-center font-mono">
          Protected by SHA-256 Cryptographic Audit Ledger & Local Air-Gap Policy
        </p>
      </div>
    </div>
  );
